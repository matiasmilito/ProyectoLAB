    ...
    <>
      <div className={styles.contenedor}>
        <div className={styles.columnaUno}>
          <h4 className={styles.titulosFooter}>Nuestras redes:</h4>
          <ul className={styles.lista}>
            ...
            <li>
              <div className={styles.contenedorLink}>
                <a className={styles.link} href="http://facebook.com" target={'_blank'}>
            ...
            <li>
              <div className={styles.contenedorLink}>
                <a className={styles.link} href="http://youtube.com" target={'_blank'}>
        ...
        <h4 className={styles.titulosFooter}>Contactanos:</h4>
          <ul className={styles.lista}>
